...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ws_api_client.GenerationWithMakeAndModel();
  });
  ...
  describe('GenerationWithMakeAndModel', function() {
    it('should create an instance of GenerationWithMakeAndModel', function() {
      // uncomment below and update the code to test GenerationWithMakeAndModel
      //var instance = new ws_api_client.GenerationWithMakeAndModel();
      //expect(instance).to.be.a(ws_api_client.GenerationWithMakeAndModel);
    });
