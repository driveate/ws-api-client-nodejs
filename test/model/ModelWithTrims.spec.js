...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ws_api_client.ModelWithTrims();
  });
  ...
  describe('ModelWithTrims', function() {
    it('should create an instance of ModelWithTrims', function() {
      // uncomment below and update the code to test ModelWithTrims
      //var instance = new ws_api_client.ModelWithTrims();
      //expect(instance).to.be.a(ws_api_client.ModelWithTrims);
    });
