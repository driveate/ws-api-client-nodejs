...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ws_api_client.SizeAggregation();
  });
  ...
  describe('SizeAggregation', function() {
    it('should create an instance of SizeAggregation', function() {
      // uncomment below and update the code to test SizeAggregation
      //var instance = new ws_api_client.SizeAggregation();
      //expect(instance).to.be.a(ws_api_client.SizeAggregation);
    });
