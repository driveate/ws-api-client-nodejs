...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ws_api_client.Tire();
  });
  ...
  describe('Tire', function() {
    it('should create an instance of Tire', function() {
      // uncomment below and update the code to test Tire
      //var instance = new ws_api_client.Tire();
      //expect(instance).to.be.a(ws_api_client.Tire);
    });
