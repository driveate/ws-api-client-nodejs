...
(function(root, factory) {
   ...
   * @param rimDiameter {Number} Rim diameter, in (e.g. `18.0`, can be __*`null`*__)
   * @param rimWidth {Number} Rim width, in (e.g. `7.0`, can be __*`null`*__)
   * @param rimOffset {Number} Rim offset, mm (e.g. `38.0`, can be __*`null`*__)
   * @param tire {String} Formatted tire size (e.g. `225/55R18`, can be __*`\"\"`*__)
   * @param tireSizingSystem {module:model/Wheel.TireSizingSystemEnum} Tire sizing system (e.g. `metric`, can be __*`null`*__)
   * @param tireConstruction {module:model/Wheel.TireConstructionEnum} Tire constriction code (e.g. `R`, can be __*`null`*__)
   * @param tireWidth {Number} Tire width, mm (e.g. `225.0`, can be __*`null`*__)
   * @param tireAspectRatio {Number} Aspect ratio, % (e.g. `55.0`, can be __*`null`*__)
   * @param tireDiameter {Number} High flotation tire diameter, in (e.g. `31.0`, can be __*`null`*__)
   * @param tireSectionWidth {Number} High flotation section width, in (e.g. `10.5`, can be __*`null`*__)
   * @param tireIs82series {Boolean} Is an old tire with assumed aspect ratio 82%
   */
  var exports = function(rim, rimDiameter, rimWidth, rimOffset, tire, tireSizingSystem, tireConstruction, tireWidth, tireAspectRatio, tireDiameter, tireSectionWidth, tireIs82series) {
    var _this = this;


    _this['rim'] = rim;
    _this['rim_diameter'] = rimDiameter;
    _this['rim_width'] = rimWidth;
    _this['rim_offset'] = rimOffset;
    _this['tire'] = tire;
    _this['tire_sizing_system'] = tireSizingSystem;
    _this['tire_construction'] = tireConstruction;
    _this['tire_width'] = tireWidth;
    _this['tire_aspect_ratio'] = tireAspectRatio;
    _this['tire_diameter'] = tireDiameter;
    _this['tire_section_width'] = tireSectionWidth;
